...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = $values['accessKeyId']; // AccessKeyId
        
        $accessKeySecret = $values['accessKeySecret']; // AccessKeySecret
    ...
    public static function sendSms() {
        ...
        $request->setSignName($values['SignName']);


        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode($values['TemplateCode']);
